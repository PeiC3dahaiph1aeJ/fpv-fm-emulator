...
```
50 офлайн-тестів, апаратура не потрібна. Покривають: пошук бендів/каналів (зокрема
...
несучих, попередження про аліасинг, і прогони рушія сценаріїв на записувальному
приймачі (свіп, пауза з RF off, порядок «спершу перестроїти, потім старт», рамп
потужності, жива потужність).
