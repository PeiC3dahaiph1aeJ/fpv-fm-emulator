...
1. **[⬇ Завантажити ZIP — v0.5.2](https://github.com/Zapadenec1982/fpv-fm-emulator/archive/refs/tags/v0.5.2.zip)** — версія з
...
tests/            офлайн-тести ядра (pytest, 181 шт.)
```
...
```
181 офлайн-тест, апаратура не потрібна. Покривають: пошук бендів/каналів (зокрема
